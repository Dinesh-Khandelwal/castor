...
public final class MappingUnmarshaller {
	...
	**/
	 ...
	 */
	public MappingLoader getMappingLoader(final Mapping mapping, final BindingType bindingType) throws MappingException {
	 ...
	 *         descriptors from being generated from the loaded mapping.
	 */
	public MappingLoader getMappingLoader(final Mapping mapping, final BindingType bindingType, final Object param) throws MappingException {
		synchronized (this) {
			...
			_internalContext.setClassLoader(mapping.getClassLoader());
	 ...
	 */
	protected void loadMappingInternal(final Mapping mapping, final DTDResolver resolver, final String url) throws IOException, MappingException {
		try {
	 ...
	 * @throws MappingException The mapping file is invalid.
	 */
	private void loadMappingInternal(final Mapping mapping, final DTDResolver resolver, final InputSource source) throws MappingException {
