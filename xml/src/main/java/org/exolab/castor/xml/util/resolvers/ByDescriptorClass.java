...
public class ByDescriptorClass extends AbstractResolverClassCommand {
    ...
    protected Map internalResolve(final String className, final ClassLoader classLoader,
        ...
        // Try to load with the pattern which BF supports then load the default one. Which will help avoiding thread blocks on the classloader for a wrong file pattern.
